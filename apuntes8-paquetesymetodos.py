...
Luego a la hora de utilizar las funciones y clases de ese módulo llamaremos primero al modulo y luego a la herramienta que queramos utilizar de ese módulo siguiendo esta sintaxis:

ALIAS_DEL_MODULO.FUNCIÓN o MODULO.FUNCIÓN

ALIAS_DEL_MODULO.CLASE o MODULO.CLASE

Siguiendo estas directrices, la sintaxis correcta de nuestro código en main.py es la siguiente:

from usuarios import funciones_usuarios

resultado_suma = funciones_usuarios.suma(3, 5)

print(resultado_suma)

o bien, si queremos añadir un alias:

from usuarios import funciones_usuarios as fu

resultado_suma = fu.suma(3, 5)
